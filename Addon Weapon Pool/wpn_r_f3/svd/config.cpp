...
class CfgWeapons
{
	...
	class str_tigr: str_svd
	{
		author="ettubrutesbro, wang - chung";
		displayname="$STR_tigr_name";
		model="wpn_r_f3\svd\svd1.p3d";
		picture="\wpn_r_f3\svd\ui\gear_tigr_x_ca";
		discreteDistance[]={100,200,300,400,500};
		descriptionshort="$STR_tigr_desc";
		magazines[]=
		{
			"10rnd_762_svd"
		};
